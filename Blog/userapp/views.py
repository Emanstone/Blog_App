...
class BecomeAuthor(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        # To prevent the user from filling in 'none'
        # # Validate each field, ignoring empty fields and preventing 'none' values
        ...
        #     if field_value == 'none':
        #         # Raise an error if the field value is 'none'
        #         raise ValidationError(f'{field_name} field cannot be "none".')

        #     # Validate the field value (specific validation logic for each field)
        #     # ...

        #     # Proceed with processing if all fields are valid
        #     # ...
